# computes a distance matrix between themes
# and a 'shared quote' matrix 
# so for each theme, compute distance to all other themes
# and compute share qoutes with each other theme 
